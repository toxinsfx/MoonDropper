...
cmds["chat"] = function(args, p)
  if(args[1] == "" or args[1] == nil) then
     game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Moon ON TOP!","All")
  else
     local str = ""
     for i = 1,50 do
...
cmds["tp"] = function(args, p)
  if(args[1] == "" or args[1] == nil) then
     game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("[Moon] Please input place to teleport to.","All")
  else
       game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("[Moon] Teleporting to '" .. args[1] .. "'!","All")
...
cmds["start"] = function(args, p)
  game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("[Moon] Started Dropping!","All")
  dropping = true
  repeat
...
cmds["stop"] = function(args, p)
  dropping = false
  game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("[Moon] Stopped dropping!","All")
end
...
cmds["goto"] = function(args, p)
  if(args[1] == "" or args[1] == nil) then
    ...
    if(game.Workspace:FindFirstChild(args[1]) == nil) then
      game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("[Moon] Character doesnt exist.","All")
    else
